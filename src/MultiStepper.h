...
/// \brief Operate multiple SuperSteppers in a co-ordinated fashion
///
/// This class can manage multiple SuperSteppers (up to
...
class MultiStepper {
 public:
  ...
  boolean addStepper(SuperStepper& stepper);
 ...
 private:
  ...
  SuperStepper* _steppers[MULTISTEPPER_MAX_STEPPERS];
