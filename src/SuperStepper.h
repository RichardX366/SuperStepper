...
/////////////////////////////////////////////////////////////////////
/// \class SuperStepper SuperStepper.h <SuperStepper.h>
...
/// SuperStepper will not have a correct
...
class SuperStepper {
 public:
  ...
  /// Use this in the pins argument the SuperStepper constructor to
  ...
  /// MotorInterfaceType symbolic names. SuperStepper::DRIVER (1) means a
  ...
  /// this with setMinPulseWidth(). SuperStepper::FULL2WIRE (2) means a 2 wire
  /// stepper (2 pins required). SuperStepper::FULL3WIRE (3) means a 3 wire
  /// stepper, such as HDD spindle (3 pins required). SuperStepper::FULL4WIRE
  /// (4) means a 4 wire stepper (4 pins required). SuperStepper::HALF3WIRE (6)
  /// means a 3 wire half stepper, such as HDD spindle (3 pins required)
  /// SuperStepper::HALF4WIRE (8) means a 4 wire half stepper (4 pins required)
  /// Defaults to SuperStepper::FULL4WIRE (4) pins.
  /// \param[in] pin1 Arduino digital pin number for motor pin 1. Defaults
  /// to pin 2. For a SuperStepper::DRIVER (interface==1),
  ...
  /// to pin 3. For a SuperStepper::DRIVER (interface==1),
 ...
 private:
  ...
  /// The target position in steps. The SuperStepper library will move the
...
/// Shows how to use SuperStepper to control a 3-phase motor, such as a HDD
/// spindle motor using the Adafruit Motor Shield
/// http://www.ladyada.net/make/mshield/index.html.

/// @example DualMotorShield.pde
/// Shows how to use SuperStepper to control 2 x 2 phase steppers using the
